...
export default function Inventory__InspirationCard({ thumbnail, title, par }: CardProps) {
	...
	return (
		<div className="inspiration_card bg-zircon grid m-0 mb-4 h-full rounded-xl overflow-hidden flex-column flex-nowrap sm:flex-row sm:mb-0">
			<div className="grid m-0">
				<div className="inspiration_card__thumb_wrapper flex flex-center col-12 p-0 m-0 sm:col-5">
					...
					{thumbnailType === "image" && <img src={thumbnail} className="inspiration_card__thumb w-full" loading="lazy" />}
				</div>
