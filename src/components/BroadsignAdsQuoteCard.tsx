	...
	if (name && title && company && quote) {
		return (
			<div className="quote_card grid m-0 h-full rounded-xl overflow-hidden flex-column flex-nowrap sm:flex-row">
				<div className="quote_card__author_wrapper bg-gradient col-12 p-8 sm:col-3">
				...
				<div className="quote_card__blockquote_wrapper bg-zircon col-12 px-7 py-5 flex align-items-start sm:col-9 sm:align-items-center sm:text-20 sm:p-20">
					<blockquote>
						<p className="text-reflex line-height-180 font-serif m-0">{quote}</p>
					</blockquote>
				</div>
			</div>
		);
