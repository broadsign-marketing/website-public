...
export default function EbookDynamicAndInteractiveContent({ pageContext: { l, dicoPath }, location, data }) {
	useDico(l, dicoPath);
...
export const queryContact = graphql`
	query EBookImages {
		hero: file(relativePath: { eq: "ebooks/dynamic-and-interactive-content.jpg" }) {
			childImageSharp {
				gatsbyImageData
			}
		}
