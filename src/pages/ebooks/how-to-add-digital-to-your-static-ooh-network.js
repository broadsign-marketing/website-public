...
export default function EbookAddDigitalToYourOOHNetwork({ pageContext: { l, dicoPath }, location, data }) {
	useDico(l, dicoPath);
...
export const queryContact = graphql`
	query EBookImages {
		hero: file(relativePath: { eq: "ebooks/how-to-add-digital-to-your-static-ooh-network.jpg" }) {
			childImageSharp {
				gatsbyImageData
			}
		}
