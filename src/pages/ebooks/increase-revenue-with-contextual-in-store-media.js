...
export default function EbookIncreaseRevenueWithContextualInStoreMedia({ pageContext: { l, dicoPath }, location, data }) {
	useDico(l, dicoPath);
...
export const queryContact = graphql`
	query EBookImages {
		hero: file(relativePath: { eq: "ebooks/increase-revenue-with-contextual-in-store-media.jpg" }) {
			childImageSharp {
				gatsbyImageData
			}
		}
