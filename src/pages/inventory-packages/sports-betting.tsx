...
export default function InventoryPackagesSportsBetting({ pageContext: { l, dicoPath }, data }: PageProps) {
	...
	return (
		<Layout id="sports_betting" className="theme_carolina auction_packages">
			...
			<Hero carouselBaseImage={data.hero.childImageSharp.gatsbyImageData} carouselRotatingImages={[]} variation="ppc" />
