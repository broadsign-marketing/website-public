...
export default function AuctionPackagesCPG({ pageContext: { l, dicoPath }, data }: PageProps) {
	useDico(l, dicoPath);
	useDicoNamespace("auction-packages");

	return (
		<Layout id="cpg" className="theme_carolina auction_packages">
			<Hero
...
export const QueryAuctionPackagesTravelTourism = graphql`
	query {
		hero: file(relativePath: { eq: "auction-packages/cpg/hero_base.png" }) {
			...img
		}
		hero01: file(relativePath: { eq: "auction-packages/cpg/hero_01.png" }) {
			...img
		}
		hero02: file(relativePath: { eq: "auction-packages/cpg/hero_02.png" }) {
			...img
		}
		hero03: file(relativePath: { eq: "auction-packages/cpg/hero_03.png" }) {
			...img
		}

		screenshot: file(relativePath: { eq: "auction-packages/cpg/screenshot.jpg" }) {
			...img
		}
		advantages: file(relativePath: { eq: "auction-packages/cpg/advantages.png" }) {
			...img
		}

		playbook_thumb_01: file(relativePath: { eq: "auction-packages/cpg/playbook_thumb_01.jpg" }) {
			...img
		}
		playbook_thumb_02: file(relativePath: { eq: "auction-packages/cpg/playbook_thumb_02.jpg" }) {
			...img
		}
		playbook_thumb_03: file(relativePath: { eq: "auction-packages/cpg/playbook_thumb_03.jpg" }) {
			...img
		}
	}
`;
...
/* query ($l: String!) {
		hero: file(relativePath: { eq: "auction-packages/cpg/hero.png" }) {
			...img
		}
	} */
