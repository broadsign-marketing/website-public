...
export default function AuctionPackagesHealthcare({ pageContext: { l, dicoPath }, data }: PageProps) {
	useDico(l, dicoPath);
	useDicoNamespace("auction-packages");

	return (
		<Layout id="healthcare_pharma" className="theme_carolina auction_packages">
			<Hero
			...
			<section className="marketplace bg-zircon">
				<Marketplace current="healthcarePharma" />
...
export const QueryAuctionPackagesTravelTourism = graphql`
	query {
		hero: file(relativePath: { eq: "auction-packages/healthcare_pharma/hero_base.png" }) {
			...img
		}
		hero01: file(relativePath: { eq: "auction-packages/healthcare_pharma/hero_01.png" }) {
			...img
		}
		hero02: file(relativePath: { eq: "auction-packages/healthcare_pharma/hero_02.png" }) {
			...img
		}
		hero03: file(relativePath: { eq: "auction-packages/healthcare_pharma/hero_03.png" }) {
			...img
		}

		screenshot: file(relativePath: { eq: "auction-packages/healthcare_pharma/screenshot.jpg" }) {
			...img
		}
		advantages: file(relativePath: { eq: "auction-packages/healthcare_pharma/advantages.png" }) {
			...img
		}

		playbook_thumb_01: file(relativePath: { eq: "auction-packages/healthcare_pharma/playbook_thumb_01.jpg" }) {
			...img
		}
		playbook_thumb_02: file(relativePath: { eq: "auction-packages/healthcare_pharma/playbook_thumb_02.jpg" }) {
			...img
		}
		playbook_thumb_03: file(relativePath: { eq: "auction-packages/healthcare_pharma/playbook_thumb_03.jpg" }) {
			...img
		}
	}
`;
...
/* query ($l: String!) {
		hero: file(relativePath: { eq: "auction-packages/healthcare_pharma/hero.png" }) {
			...img
		}
	} */
