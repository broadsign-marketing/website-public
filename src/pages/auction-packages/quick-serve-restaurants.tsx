...
export default function AuctionPackagesQSR({ pageContext: { l, dicoPath }, data }: PageProps) {
	useDico(l, dicoPath);
	useDicoNamespace("auction-packages");

	return (
		<Layout id="qsr" className="theme_carolina auction_packages">
			<Hero
...
export const QueryAuctionPackagesTravelTourism = graphql`
	query {
		hero: file(relativePath: { eq: "auction-packages/qsr/hero_base.png" }) {
			...img
		}
		hero01: file(relativePath: { eq: "auction-packages/qsr/hero_01.png" }) {
			...img
		}
		hero02: file(relativePath: { eq: "auction-packages/qsr/hero_02.png" }) {
			...img
		}
		hero03: file(relativePath: { eq: "auction-packages/qsr/hero_03.png" }) {
			...img
		}

		screenshot: file(relativePath: { eq: "auction-packages/qsr/screenshot.jpg" }) {
			...img
		}
		advantages: file(relativePath: { eq: "auction-packages/qsr/advantages.png" }) {
			...img
		}

		playbook_thumb_01: file(relativePath: { eq: "auction-packages/qsr/playbook_thumb_01.jpg" }) {
			...img
		}
		playbook_thumb_02: file(relativePath: { eq: "auction-packages/qsr/playbook_thumb_02.jpg" }) {
			...img
		}
		playbook_thumb_03: file(relativePath: { eq: "auction-packages/qsr/playbook_thumb_03.jpg" }) {
			...img
		}
	}
`;
...
/* query ($l: String!) {
		hero: file(relativePath: { eq: "auction-packages/qsr/hero.png" }) {
			...img
		}
	} */
