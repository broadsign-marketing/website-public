...
export default function AuctionPackagesFinances({ pageContext: { l, dicoPath }, data }: PageProps) {
	useDico(l, dicoPath);
	useDicoNamespace("auction-packages");

	return (
		<Layout id="finances" className="theme_carolina auction_packages">
			<Hero
			...
			<section className="my-20">
				<Container>
					<CaseStudies campaigns={["ig"]} overtitle={T.translate("financesCampaigns")} bg="white" />
				</Container>
			</section>
...
export const QueryAuctionPackagesTravelTourism = graphql`
	query {
		hero: file(relativePath: { eq: "auction-packages/finances/hero_base.png" }) {
			...img
		}
		hero01: file(relativePath: { eq: "auction-packages/finances/hero_01.png" }) {
			...img
		}
		hero02: file(relativePath: { eq: "auction-packages/finances/hero_02.png" }) {
			...img
		}
		hero03: file(relativePath: { eq: "auction-packages/finances/hero_03.png" }) {
			...img
		}

		screenshot: file(relativePath: { eq: "auction-packages/finances/screenshot.jpg" }) {
			...img
		}
		advantages: file(relativePath: { eq: "auction-packages/finances/advantages.png" }) {
			...img
		}

		playbook_thumb_01: file(relativePath: { eq: "auction-packages/finances/playbook_thumb_01.jpg" }) {
			...img
		}
		playbook_thumb_02: file(relativePath: { eq: "auction-packages/finances/playbook_thumb_02.jpg" }) {
			...img
		}
		playbook_thumb_03: file(relativePath: { eq: "auction-packages/finances/playbook_thumb_03.jpg" }) {
			...img
		}
	}
`;
...
/* query ($l: String!) {
		hero: file(relativePath: { eq: "auction-packages/finances/hero.png" }) {
			...img
		}
	} */
