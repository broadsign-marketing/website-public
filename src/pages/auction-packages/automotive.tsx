...
export default function AuctionPackagesAutomotive({ pageContext: { l, dicoPath }, data }: PageProps) {
	useDico(l, dicoPath);
	useDicoNamespace("auction-packages");

	return (
		<Layout id="automotive" className="theme_carolina auction_packages">
			<Hero
				carouselBaseImage={data.hero.childImageSharp.gatsbyImageData}
				carouselRotatingImages={[data.hero01.childImageSharp.gatsbyImageData, data.hero02.childImageSharp.gatsbyImageData]}
			/>
			...
			<section className="marketplace bg-zircon">
				<Marketplace current="automotive" />
...
export const QueryAuctionPackagesTravelTourism = graphql`
	query {
		hero: file(relativePath: { eq: "auction-packages/automotive/hero_base.png" }) {
			...img
		}
		hero01: file(relativePath: { eq: "auction-packages/automotive/hero_01.png" }) {
			...img
		}
		hero02: file(relativePath: { eq: "auction-packages/automotive/hero_02.png" }) {
			...img
		}

		screenshot: file(relativePath: { eq: "auction-packages/automotive/screenshot.jpg" }) {
			...img
		}
		advantages: file(relativePath: { eq: "auction-packages/automotive/advantages.png" }) {
			...img
		}

		playbook_thumb_01: file(relativePath: { eq: "auction-packages/automotive/playbook_thumb_01.jpg" }) {
			...img
		}
		playbook_thumb_02: file(relativePath: { eq: "auction-packages/automotive/playbook_thumb_02.jpg" }) {
			...img
		}
		playbook_thumb_03: file(relativePath: { eq: "auction-packages/automotive/playbook_thumb_03.jpg" }) {
			...img
		}
	}
`;
