...
import icon_tv from "@img/pages/inventory-marketplace/city_based/icon_tv.svg";
...
import icon_medal from "@img/pages/inventory-marketplace/city_based/icon_medal.svg";
...
import icon_train from "@img/pages/inventory-marketplace/city_based/icon_train.svg";
import icon_luggage from "@img/pages/inventory-marketplace/city_based/icon_luggage.svg";

import "@sass/pages/inventory_marketplace_city_based.scss";

export default function CityBasedInventoryMarketplaceChicago({ pageContext: { l, dicoPath }, data }) {
	useDico(l, dicoPath);
	...
	return (
		<Layout id="inventory_marketplace_chicago" className="theme_carolina im_city_based">
			...
			<ExploreMoreMarkets currentCity="chicago" />
			{/* <FAQ content={faq} /> */}
		</Layout>
	);
}
...
export const queryInventoryPackages = graphql`
	query {
		hero: file(relativePath: { eq: "pages/inventory-marketplace/city_based/chicago_hero.jpg" }) {
			...img
		}

		opportunity_diversity: file(relativePath: { eq: "pages/inventory-marketplace/city_based/chicago_opportunity_diversity.jpg" }) {
			...img
		}
		opportunity_income: file(relativePath: { eq: "pages/inventory-marketplace/city_based/chicago_opportunity_income.jpg" }) {
			...img
		}
		opportunity_travel: file(relativePath: { eq: "pages/inventory-marketplace/city_based/chicago_opportunity_travel.jpg" }) {
			...img
		}
	}
`;
