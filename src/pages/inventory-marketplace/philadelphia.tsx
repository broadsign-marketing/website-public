...
export default function CityBasedInventoryMarketplacePhiladelphia({ pageContext: { l, dicoPath }, data }) {
	useDico(l, dicoPath);
	...
	return (
		<Layout id="inventory_marketplace_philadelphia" className="theme_carolina im_city_based">
			...
			<ExploreMoreMarkets currentCity="philadelphia" />
			{/* <FAQ content={faq} /> */}
		</Layout>
	);
}
...
export const queryInventoryPackages = graphql`
	query {
		hero: file(relativePath: { eq: "pages/inventory-marketplace/city_based/philadelphia_hero.jpg" }) {
			...img
		}

		opportunity_diversity: file(relativePath: { eq: "pages/inventory-marketplace/city_based/philadelphia_opportunity_diversity.jpg" }) {
			...img
		}
		opportunity_income: file(relativePath: { eq: "pages/inventory-marketplace/city_based/philadelphia_opportunity_income.jpg" }) {
			...img
		}
		opportunity_travel: file(relativePath: { eq: "pages/inventory-marketplace/city_based/philadelphia_opportunity_travel.jpg" }) {
			...img
		}
	}
`;
