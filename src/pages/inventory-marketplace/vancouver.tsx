...
import icon_script from "@img/pages/inventory-marketplace/city_based/icon_script.svg";
...
export default function CityBasedInventoryMarketplaceVancouver({ pageContext: { l, dicoPath }, data }) {
	useDico(l, dicoPath);
	...
	return (
		<Layout id="inventory_marketplace_vancouver" className="theme_carolina im_city_based">
			...
			<ExploreMoreMarkets currentCity="vancouver" />
			{/* <FAQ content={faq} /> */}
		</Layout>
	);
}
...
export const queryInventoryPackages = graphql`
	query {
		hero: file(relativePath: { eq: "pages/inventory-marketplace/city_based/vancouver_hero.jpg" }) {
			...img
		}

		opportunity_diversity: file(relativePath: { eq: "pages/inventory-marketplace/city_based/vancouver_opportunity_diversity.jpg" }) {
			...img
		}
		opportunity_income: file(relativePath: { eq: "pages/inventory-marketplace/city_based/vancouver_opportunity_income.jpg" }) {
			...img
		}
		opportunity_travel: file(relativePath: { eq: "pages/inventory-marketplace/city_based/vancouver_opportunity_travel.jpg" }) {
			...img
		}
	}
`;
