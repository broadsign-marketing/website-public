...
function Screenshot({ start = 0, src }) {
	...
	return <img src={src} className="screenshot" style={{ left: `${pos}%` }} alt="" />;
}
...
export default function free_trial__Screenshots() {
	...
	return (
		<section className="screenshots">
			{l !== "fr" && (
				<div className="inner">
					<Screenshot src={screenshot_04_en} className="screenshot" start={-33} />
					<Screenshot src={screenshot_01_en} className="screenshot" start={0} />
					<Screenshot src={screenshot_02_en} className="screenshot" start={33} />
					<Screenshot src={screenshot_03_en} className="screenshot" start={66} />
				</div>
			)}
			{l === "fr" && (
				<div className="inner">
					<Screenshot src={screenshot_04_fr} className="screenshot" start={-33} />
					<Screenshot src={screenshot_01_fr} className="screenshot" start={0} />
					<Screenshot src={screenshot_02_fr} className="screenshot" start={33} />
					<Screenshot src={screenshot_03_fr} className="screenshot" start={66} />
				</div>
			)}
		</section>
	);
