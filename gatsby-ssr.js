...
export const onPreRenderHTML = ({ getHeadComponents, replaceHeadComponents }) => {
	...
	const newHeadComponents = [
		<link rel="preconnect" href="https://dev.visualwebsiteoptimizer.com" id="vwo-visualwebsiteoptimizer" key="vwo-visualwebsiteoptimizer" />,
		<script
...
export const onRenderBody = ({ setPostBodyComponents, setHeadComponents }, pluginOptions) => {
	setPostBodyComponents([
		<div key="modal-portal" id="modal-portal">
			{pluginOptions.text}
		</div>,
		<div key="special-bg-portal" id="special-bg-portal"></div>,
	]);
};
